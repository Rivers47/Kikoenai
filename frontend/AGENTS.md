...
```javascript
{
  ...
  resumeHistorySeconds: -1,       // Resume position from history (-1 = none; cleared once applied)
  resumeHistoryTrackId: '',       // Track that resume belongs to; resumeHistoryDone is true for any other track
